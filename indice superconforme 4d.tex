...
\maketitle
\newpage
\section{Indice superconforme per Kutasov-Schwimmer (4d) (Teoria Elettrica) }
...
&+ (N_c - 1  \, \,(\mbox{da (p;p)..}) + N_c ( \sum_i^{N_f} 2 \omega(\Delta - 1 ) + m_i - \tilde{m_i} = \\
...
\,  &\frac{1}{(1-p)(1-q)} \sum_i^{N_f} \sum_j^{N_f}   \sum_{l=0}^{k-1}  \bigg( (pq)^{( s +r )}m_{ij}  - (pq)^{1 -( s +r )}
m_{ij}^{-1} \bigg) = \\ 
...
& \prod_i^{N_f} \prod_j^{N_f}  \prod_{l=0}^{k-1} \exp \sum_{n}^{\infty} \bigg( \frac{1}{n}  \frac{1}{(1-p^n)(1-q^n)} \bigg( (pq)^{(r+s)n}
m_{ij}^n - (pq)^{(1-(r+s)n} 
m_{ij}^{-n} \bigg)\\
\end{align*}

Ponendo ora $ (pq)^{r+s} = t$:
\begin{align*}
& \exp \bigg( \sum_{n}^{\infty} \frac{1}{n} i_M^{Meson} (p^n,q^n, \tilde v^n, y^n,\tilde y^n) \bigg) = \\
...
\begin{comment}
Notare come una frazione può essere riscritta come serie geometrica:
\begin{align*}
 \frac{1 - (pq)^{(1-s)}}{1 - (pq)^{s}} = \sum_{j=0}^{k-1} \big((pq)^s\big)^j = \frac{1 - (pq)^{sk}}{1 - (pq)^s} \qquad \mbox{ NB } s = \frac{1}{k+1}\\
  s k  = \frac{k}{k+1} = 1 - \frac{1}{k+1} = 1-s  
\end{align*}
Possiamo riscriverlo quindi come:
\begin{align*}
& \exp \bigg( \sum_{n}^{\infty} \frac{1}{n} i_M^{Meson} (p^n,q^n, \tilde v^n, y^n,\tilde y^n) \bigg) = \\
& \prod_i^{N_f} \prod_j^{N_f}  \exp \sum_{n}^{\infty} \bigg( \frac{1}{n}  \frac{1}{(1-p^n)(1-q^n)} \sum_{l=0}^{k-1} (pq)^{sln}  \bigg( (pq)^{rn}
m_{ij}^n - (pq)^{(2s-r)n} 
m_{ij}^{-n} \bigg)\bigg) \\
& \prod_i^{N_f} \prod_j^{N_f}  \prod_{l=0}^{k-1} \exp \sum_{n}^{\infty} \bigg( \frac{1}{n}  \frac{1}{(1-p^n)(1-q^n)} (pq)^{sln}  \bigg( (pq)^{rn}
m_{ij}^n - (pq)^{(2s-r)n} 
m_{ij}^{-n} \bigg) \bigg) \\
& \prod_i^{N_f} \prod_j^{N_f}  \prod_{l=0}^{k-1} \exp \sum_{n}^{\infty} \bigg( \frac{1}{n}  \frac{1}{(1-p^n)(1-q^n)} \bigg( (pq)^{(r+sl)n}
m_{ij}^n - (pq)^{(s(2+2l)-(r+sl))n} 
m_{ij}^{-n} \bigg) \bigg) \\
\end{align*}
Ponendo $ (pq)^{r+sl} = y$ :
\begin{align*}
& \prod_i^{N_f} \prod_j^{N_f}  \prod_{l=0}^{k-1} \exp \sum_{n}^{\infty} \bigg( \frac{1}{n}  \frac{1}{(1-p^n)(1-q^n)} \bigg( y^n
m_{ij}^n - (pq)^{s(2+2l)n}y^{-n} 
m_{ij}^{-n} \bigg) \bigg) \\ 
= \, & \prod_i^{N_f} \prod_j^{N_f}  \prod_{l=0}^{k-1} \Gamma_e ( (pq)^{r+s})
\end{align*}
